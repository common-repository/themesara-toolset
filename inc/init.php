...
class Themesara_Toolset {
	...
	public static function instance() {
		...
		if ( null === $instance ) {
			$instance = new Themesara_Toolset;
		}
    ...
    private function load_dependencies() {
        ...
        require_once THEMESARA_TOOLSET_PATH . 'inc/functions.php';
        require_once THEMESARA_TOOLSET_PATH . 'inc/hooks.php';
	...
	private function hooks() {
		...
		$plugin_admin = themesara_toolset_hooks();
        ...
        add_filter( 'wp_ajax_themesara_toolset_getting_started', array( $plugin_admin, 'install_advanced_import' ), 10, 1 );
